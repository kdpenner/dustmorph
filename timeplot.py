...
sfruv = uvfescs#*sfrfinal

#sfrir = sfrfinal-sfruv
...
ax1.plot(rangeuvfescs[:, -1], rangehafescs[:, -1], marker = 'o', color = color2)
...
plot.savefig('spread_hauv_age1.eps')
