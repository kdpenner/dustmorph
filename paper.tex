...
\altaffiltext{5}{Department of Astronomy, University of California Riverside,
...
resemble
uniform foreground screens, as commonly assumed.  We use rest-frame infrared,
...
galaxies
\citep{younger10,diaz10,simpson15}.  (The arrangement of
dust is often described, oddly, as its geometry.)  Yet spatial distributions of
...
wavelengths.  We often assume that dust grains
are distributed as a uniformly thick screen between us and the galaxy's stars
and gas \citep{calzetti94}.  From the uniform screen assumption follows an
attenuation
formula that depends solely on wavelength; intrinsic luminosity is recovered
from emergent luminosity and attenuation calculated from the formula.
...
surrounding a star in the Milky Way, not the large area containing a mix of
stars and gas in distant galaxies.  In an illustrative sense an attenuation
formula is an extinction formula convolved with a spatial distribution of dust.
...
good approximation to the truth.  The
screen assumption is qualitatively similar to a scenario in which dust is
distributed in a large number of clumps \citep{calzetti94}.  \citet{liu13} find
that the dust
distribution around ionizing stars throughout M83 is clumpy at a spatial scale
of 6 pc;
if the spatial resolution is degraded to 100 pc, we conclude that the
distribution around ionizing stars is a screen.  If we choose to think of dust
distributions as clumpy, the number of clumps surrounding nonionizing
UV-emitting stars in low-redshift dust-poor galaxies is 60\% of the number of
clumps surrounding ionizing stars \citep{calzetti97a}.
...
consider that galaxies have centers and outskirts.  A number of studies find
...
\subsection{Reproducing the relation for dust-poor galaxies}
...
\begin{itemize}
\item \alephuv~from IRX: \alephuv~= ($L_{\mathrm{IR}}$/($1.68\times0.16\times
L_{\mathrm{0.16}}$)+1)$^{-1}$.  (Equivalent to \alephuv~= [emergent UV
...
low redshift.  In \S\ref{subsec:highz} and \ref{sec:discuss} we explain why we
...
If we assume that dusty galaxies obey the \citet{calzetti00} attenuation
formula, our results indicate that their H$\alpha$ and 0.66$\,\micron$ escape
...
\alephhb.  Both line luminosities are from ionized gas surrounding the same
stars, so this prediction is immune to an uncertain star formation history.
The ratio of intrinsic
...
determination is history-independent.  If
...
ALMA is beginning to produce images of the dust distributions in galaxies.
These images lead to direct tests, independent of the attenuation formula, of
the uniform screen assumption.  They also have the potential to reveal the
parts of galaxies that may never be detected at UV and optical wavelengths:
surprises surely abound.
...
Brammer, G.~B., et al.\ 2013, arXiv:1310.4177
